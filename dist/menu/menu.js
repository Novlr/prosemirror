...
var MenuCommand = exports.MenuCommand = function () {
  ...
  _createClass(MenuCommand, [{
    ...
    value: function render(pm) {
      ...
      if (!disp) throw new _error.AssertionError("No display style defined for menu command " + cmd.name);
      ...
      if (disp.render) {
        ...
        throw new _error.AssertionError("Unsupported command display style: " + disp.type);
      }
